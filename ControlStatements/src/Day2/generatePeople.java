...
public class generatePeople {
    ...
    public static Person bob = new Person("Bob", "Patel", (short) 160, 52.5, LocalDate.of(1989,4,8), SexType.MALE, BloodType.A);

    public static Person ted = new Person("Ted", "Patel", (short) 180, 60.5, LocalDate.of(1989, 9 , 8), SexType.MALE, BloodType.B );
